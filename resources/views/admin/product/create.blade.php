...
@section('content')
    <section class="py-3">
        <form action="{{ route('product.store') }}" method="post" enctype='multipart/form-data'>
            {{csrf_field()}}
            <input type="hidden" name="tags_hidden" value="{{old('tags_hidden')}}">
            <input type="hidden" name="size_hidden" value="{{old('size_hidden')}}">

            <section class="form-group">
                <label for="title">Title</label>
                <input maxlength="20" name="title" value="{{ old('title') }}" required type="text" class="form-control" id="title" aria-describedby="titleHelp" placeholder="Title">
            ...
            <section class="row">
                <section class="form-group col-md">
                    ...
                    <input maxlength="20" name="price" value="{{ old('price') }}" required type="number" class="form-control" id="price" aria-describedby="priceHelp" min="0" placeholder="Price" step="any">
                ...
                <section class="form-group col-md">
                    ...
                    <input maxlength="20" name="code" value="{{ old('code') }}" required type="text" class="form-control" id="code" aria-describedby="codeHelp" placeholder="Code">
            ...
            <section class="form-group">
                ...
                <textarea name="description" rows="5" required class="form-control" id="description" aria-describedby="descriptionHelp" placeholder="Description">{{ old('description') }}</textarea>
            ...
            <section class="row flex-column" id="sekiller">
                ...
                <section class="w-100 d-flex flex-wrap">
                    <section class="col-md-6">
                        ...
                        <small id="sizeHelp" class="form-text text-muted">
                            @if ($errors->has('sekil'))
                                <b class="text-danger">{{ $errors->first('sekil') }}</b>
                            @else
                                Şəkillər
                            @endif
                        </small>
            ...
            <button type="submit" class="btn btn-success mt-5 w-100">Əlavə et</button>
        </form>
    </section>
@endsection